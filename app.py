...
db = SQLAlchemy(app)
# Gevent ve SocketIO Yapılandırması
socketio = SocketIO(app, async_mode='gevent', cors_allowed_origins="*", websocket_engine='gevent')
...
# ==========================================
# YARDIMCI SAYAÇ FONKSİYONU (Gevent Uyumlu)
# ==========================================
...
def mezat_baslat():
    ...
    if urun:
        ...
        sayac_aktif = False
        socketio.sleep(0.1)
        # Gevent uyumlu arka plan görevi başlatma
