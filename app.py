...
def geri_sayim_gorevi(saniye):
    global sayac_kalan, sayac_aktif, mezat_durumu, aktif_urun_id, _son_durum_verisi
    sayac_kalan = saniye
    sayac_aktif = True
...
def durum_getir():
    ...
    # 1 saniyelik mikro-önbellek (500+ eşzamanlı istekte kilitlenmeyi önler)
...
def on_teklif_ver():
    global mezat_durumu, aktif_urun_id, _son_durum_verisi
    veri = request.json or {}
...
def pey_ver():
    global mezat_durumu, aktif_urun_id, sayac_kalan, _son_durum_verisi
    veri = request.json or {}
    client_ip = get_client_ip()
...
def mezat_baslat():
    global mezat_durumu, aktif_urun_id, sayac_aktif, _son_durum_verisi
    veri = request.json or {}
