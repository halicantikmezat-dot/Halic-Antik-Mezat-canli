...
# KALICI 50 GB DİSK YOLU VE GEÇİCİ YEDEK
...
def durum_getir():
    ...
    try:
        ...
        urunler = [u.to_dict() for u in Urun.query.order_by(Urun.lot_no.asc()).all()]
...
# ==========================================
# ÜRÜN DÜZENLEME ROUTE (YENİ EKLENDİ)
# ==========================================
...
def urun_guncelle():
    ...
    try:
        ...
        # Eğer sahnede bu ürün varsa canlı bilgileri de güncelle
