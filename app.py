...
# HIZLI VE GELİŞMİŞ ARAMA MOTORU (YÖNETİCİ & İZLEYİCİ)
...
# ÖN TEKLİF VERME (100 TL SINIRLAMASI YOK, AÇILIŞ ALTI YASAK)
...
# ÖN TEKLİF SİLME (GÖLGE FİYAT HATASI GİDERİLDİ)
    ...
    try:
        if ot_id:
            ...
            if ot:
                ...
                # Silinen ürünün fiyatını kalanlara göre yeniden belirle
...
# CANLI PEY VERME (100 TL SINIRLAMASI YOK, %10 VE SON 10 SN -> 15 SN UZATMA)
...
def pey_ver():
    ...
    if islem == 'pey':
        ...
        if artis > 0:
            ...
            # Doğrudan %10 artış (100 TL taban şartı kaldırıldı)
        ...
        # Son 10 saniyede teklif gelirse sayacı 15 saniyeye geri sar
