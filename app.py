...
# Yüksek dosya boyutu desteği (10+ video & yüksek çözünürlüklü fotoğraflar için)
...
# ==========================================
# GERİ SAYIM MOTORU (15 SN HEYECAN VE UZATMA)
# ==========================================
...
# ==========================================
# DURUM GETİR (KESİN CİRO & SATIŞ HESAPLAMA)
# ==========================================
...
def durum_getir():
    ...
    if _son_durum_verisi and (suan - _son_durum_zamani < 0.5):
        ...
        for u in satilan_urunler:
            ...
            if m_adi not in gruplanmis_dosyalar:
                gruplanmis_dosyalar[m_adi] = {
                    "musteri_adi": m_adi,
                    "telefon": kullanici_tel_map.get(m_adi.lower(), "-"),
                    "urunler": [],
                    "toplam_tutar": 0.0
                }
...
# ==========================================
# CANLI PEY VERME VE KESİN HEMEN AL (SATIŞ MÜHÜRLEME)
# ==========================================
...
def pey_ver():
    ...
    if islem == 'hemen_al':
        ...
        # 1. Ürünün veritabanı durumunu mühürle
        urun.durum = 'Satıldı'
        urun.guncel_fiyat = hemen_al_fiyat
        urun.kazanan_adi = musteri_adi
        
        # 2. Canlı mezat durumunu güncelle
        mezat_durumu['durum'] = 'Satıldı'
        ...
        # 3. Önbelleği tamamen temizle
        _son_durum_verisi = None
        _son_durum_zamani = 0
        _son_canli_verisi = None
        _son_canli_zamani = 0
        
        # 4. Socket ile hem izleyiciye hem admin'e zorunlu bildirim bas
    ...
    if islem == 'pey':
        ...
        # Son 10 saniyede teklif gelirse süreyi 15 saniyeye çek
