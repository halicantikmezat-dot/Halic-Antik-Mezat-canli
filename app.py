...
sayac_kalan = 0
sayac_aktif = False
sayac_gorev_id = 0  # Eski sayaç döngülerinin çakışmasını engellemek için versiyon takibi
...
def geri_sayim_gorevi(saniye, gorev_id):
    ...
    # Eğer bu görev hala aktif görev ise ve süre bittiyse satışı mühürle
    if sayac_aktif and sayac_gorev_id == gorev_id:
        sayac_aktif = False
...
# ==========================================
# CANLI PEY VERME VE KESİN 15 SN UZATMA
# ==========================================
...
def pey_ver():
    ...
    if islem == 'pey':
        ...
        # Son 10 saniyede veya altında teklif gelirse sayacı 15 saniyeye geri sar ve anında yayınla
...
def mezat_baslat():
    ...
    if urun_id:
        ...
        sayac_gorev_id += 1  # Önceki tüm sayım döngülerini geçersiz kıl
        sayac_aktif = True
