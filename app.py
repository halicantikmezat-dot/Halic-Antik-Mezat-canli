...
# Diğer importlar buradan sonra gelmeli
...
def geri_sayim_gorevi(saniye):
    ...
    while sayac_kalan > 0 and sayac_aktif:
        ...
        socketio.sleep(1)  # Gevent kilitlenmesini önlemek için socketio.sleep kullanıyoruz
        sayac_kalan -= 1
...
def durum_getir():
    ...
    try:
        ...
        # MÜŞTERİ DOSYALARI VE EKSTRE GRUPLAMASI
